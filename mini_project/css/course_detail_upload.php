...
$c_name = mysqli_real_escape_string($conn, $_GET['course_name']);
$c_id = mysqli_real_escape_string($conn, $_GET['course_id']);
$t_name = mysqli_real_escape_string($conn, $_GET['teacher_name']);

$sql="INSERT INTO course_info (course_name, course_id, t_name) VALUES ('$c_name', '$c_id', '$t_name')";
$results = mysqli_query($conn, $sql);

$myfile = fopen("$c_id.php", "w") or die("Unable to open file!");
$txt = "
<html>
<body>
<style>
...
<img class=\"bgimg\" src=\"\mini_project\img\background_img.jpeg\">
    <h1 class=\"c_name\">$c_name</h1>
    <h2 class=\"c_id\">($c_id)</h2>
